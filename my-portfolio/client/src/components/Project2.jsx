    ...
    <div className="container rounded-sm mx-auto drop-shadow-md overflow-hidden mb-4">
      ...
      <div className="bg-white p-5 sm:p-8">
          ...
          <div className="sm:row-start-3 lg:col-start-3 lg:col-end-6 sm:mt-3 ml-6">
            ...
            <div className="sm:mt-8 mt-4 sm:ml-6 ml-0 sm:text-lg text-sm">
              <ul className="flex flex-row flex-wrap gap-4 font-bold text-ivory">
                <li className="">
                  <Link
                    to="https://github.com/tylermjarvis/my-bootstrap-project"
                ...
                <li className="">
                  <Link
                    to="https://bootstrap-portfolio-f4zu.onrender.com"
        ...
        <div className="md:p-10 md:pl-16 md:pr-16 sm:mb-2 mb-5">
          ...
          >
            <img
              src={ProjectTwoImageOne}
              alt="Image of project - Homepage"
              className="h-full w-full object cover"
            />
            <img
              src={ProjectTwoImageTwo}
              alt="Image of project - Landscaping page"
              className="h-full w-full object cover"
            />
            <img
              src={ProjectTwoImageThree}
              alt="Image of project - Photography page"
              className="h-full w-full object cover"
            />
            <img
              src={ProjectTwoImageFour}
              alt="Image of project - Portfolio page"
              className="h-full w-full object cover"
            />
          </Carousel>
        </div>
