          ...
          <div className="sm:row-start-3 lg:col-start-3 lg:col-end-6 sm:mt-3 ml-6">
            <div className="sm:ml-6 ml-0 sm:text-base text-sm">
              <ul className="flex flex-row flex-wrap sm:gap-8 gap-5 font-bold text-gray-800">
                <li className="">
                  <p className="">{t("LanguagesAndSoftware.5")}</p>
                </li>
                <li className="">
                ...
                <li className="">
                  <p className="">{t("LanguagesAndSoftware.10")}</p>
                </li>
              </ul>
            </div>
            <div className="sm:mt-8 mt-4 sm:ml-6 ml-0 sm:text-lg text-sm">
              <ul className="flex flex-row flex-wrap gap-4 font-bold text-ivory">
                <li className="">
                  <Link
                    to="https://github.com/tylermjarvis/react-online-shop"
        ...
        <div className="md:p-10 md:pl-16 md:pr-16 sm:mb-2 mb-5">
          ...
          >
            <img
              ...
              alt="Image of project - Homepage of online shop"
              className="h-full w-full object cover"
            />
            <img
              src={ProjectThreeImageTwo}
              alt="Image of project - Filter example using the chocolate category"
              className="h-full w-full object cover"
            />
            <img
              src={ProjectThreeImageThree}
              alt="Image of project - Stripe purchase details page"
              className="h-full w-full object cover"
            />
          </Carousel>
        </div>
